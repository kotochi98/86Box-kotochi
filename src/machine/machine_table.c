...
const machine_t machines[] = {
       ...
       firmware. */
    {
        ...
        .bus_flags = MACHINE_PS2_PCI | MACHINE_BUS_USB,
        .flags     = MACHINE_IDE_DUAL | MACHINE_APM | MACHINE_ACPI | MACHINE_USB, /* Has internal video: ATi 3D Rage Pro Turbo (AGP), sound: ESS ES1938S */
        .ram       = {
            .min  = 8192,
            .max  = 524288,
            .step = 8192
    ...
    /* Has an ITE IT8671F Super I/O chip with on-chip KBC with AMIKey-2 KBC
       firmware. */
    {
        .name              = "[i440EX] PCPartner EXB854S",
        .internal_name     = "exb854s",
        .type              = MACHINE_TYPE_SOCKET370,
        .chipset           = MACHINE_CHIPSET_INTEL_440EX,
        .init              = machine_at_exb854s_init,
        .p1_handler        = machine_generic_p1_handler,
        .gpio_handler      = NULL,
        .available_flag    = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
    ...
    /* Has the VIA VT82C586B southbridge with on-chip KBC identical to the VIA
       VT82C42N. */
    {
        .name              = "[VIA Apollo Pro] PCPartner APAS3-C966",
        .internal_name     = "apas3",
        .type              = MACHINE_TYPE_SOCKET370,
        .chipset           = MACHINE_CHIPSET_VIA_APOLLO_PRO,
